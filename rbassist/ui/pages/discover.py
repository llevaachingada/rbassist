...
class DiscoverPage:
    ...
    def _on_rec_click(self, track: dict | None) -> None:
        ...
        self._set_detail_card(
            ...
            summary=summary,
            metrics=f"Tempo: {bpm_text} | Key: {key_text} | Tags: {tags}",
            note=(
                "The current sliders decide how much overall sound, texture, low-end feel, groove, tempo, harmonic fit, and tags matter."
                if not self.browse_mode
